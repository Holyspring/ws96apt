...
点击GitHub
打开以后就可以发现有三个输入框，第一个是你在GitHub上创建的项目文件夹（我的是ws96apt）
第二个是你想要放置ws96apt的位置（也就是ws96apt会下载到这个地方）
第三个是文件夹名称

点击Clone,用过GitHub的肯定知道，这个就是把你在GIT上创建的项目文件夹同步到本地
稍等一会儿，你会发现你的PyCharm的项目栏中多了一个文件夹，我的是ws96apt

现在我就可以在ws96apt里面创建项目进行操作了
